...
public class BookController {
    ...
    public void handleUserInput(String input, String prompt) {
        ...
        switch (prompt) {
            ...
            case "Podaj autora książki:":
                tempBook = new Book(tempBook.getTitle(), input, "", 0, 0, "");
                bookView.promptForInput("Podaj gatunek książki:");
                break;

            case "Podaj gatunek książki:":
                tempBook = new Book(tempBook.getTitle(), tempBook.getAuthor(), input, 0, 0, "");
            ...
            case "Podaj ilość stron:":
                try {
                    ...
                    tempBook = new Book(tempBook.getTitle(), tempBook.getAuthor(), tempBook.getGenre(), pageCount, 0, "");
            ...
            case "Podaj rok wydania:":
                try {
                    ...
                    tempBook = new Book(tempBook.getTitle(), tempBook.getAuthor(), tempBook.getGenre(), tempBook.getPageCount(), year, "");
            ...
            case "Podaj opis książki:":
                tempBook = new Book(tempBook.getTitle(), tempBook.getAuthor(), tempBook.getGenre(), tempBook.getPageCount(), tempBook.getYear(), input);
